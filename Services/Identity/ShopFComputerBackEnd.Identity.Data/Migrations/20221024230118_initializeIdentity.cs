        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtpVerify = table.Column<string>(type: "text", nullable: true),
                    CreatedTime = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    ModifiedTime = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    ModifiedBy = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceInfo = table.Column<DeviceInfoValueObject>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Type = table.Column<PermissionType>(type: "permission_type", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "RefreshTokens",
                column: "Id")
                .Annotation("Npgsql:IndexInclude", new[] { "UserId", "DeviceId", "RefreshToken", "ExpiredTime", "RevokedTime", "DeviceInfo" });

            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_RefreshToken",
                table: "RefreshTokens",
                column: "RefreshToken")
                .Annotation("Npgsql:IndexInclude", new[] { "Id", "UserId", "DeviceId", "ExpiredTime", "RevokedTime", "DeviceInfo" });
        }
