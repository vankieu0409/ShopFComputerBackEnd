...
{
    public class NotificationTemplateUpdatedEvent : EventBase
    {
        public NotificationTemplateUpdatedEvent(Guid id, NotificationTemplateEntity template, Guid? modifiedBy)
        {
            Id = id;
            Template = template;
